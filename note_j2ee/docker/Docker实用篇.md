...
需求：基于openjdk:8-alpine镜像，将一个Java项目构建为镜像
...
执行 docker-compose 命令时，不用显示指定文件，只需要到我们的 docker-compose.yaml 所在文件执行命令就可以。
...
```sh
docker-compose logs -f uservice
```
...
当 dockerfile 或者 jar 包出现变动后，重新构建
...
![image-20240227210424787](https://raw.githubusercontent.com/Quinlan7/pic_cloud/main/img/202402272104953.png)
